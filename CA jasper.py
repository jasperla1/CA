...
"""    
    def rule30(self):
        ...
        for i in range(1,self.n+1):
            ...
            if [temp_cells[i-1],temp_cells[i],temp_cells[i+1]] == [1,1,1]:

                new_cells[i-1] = 0
            elif [temp_cells[i-1],temp_cells[i],temp_cells[i+1]] == [1,1,0]:
                new_cells[i-1] = 0

            elif [temp_cells[i-1],temp_cells[i],temp_cells[i+1]] == [1,0,1]:
                new_cells[i-1] = 0

            elif [temp_cells[i-1],temp_cells[i],temp_cells[i+1]] == [1,0,0]:
                new_cells[i-1] = 1

            elif [temp_cells[i-1],temp_cells[i],temp_cells[i+1]] == [0,1,1]:
                new_cells[i-1] = 1

            elif [temp_cells[i-1],temp_cells[i],temp_cells[i+1]] == [0,1,0]:
                new_cells[i-1] = 1

            elif [temp_cells[i-1],temp_cells[i],temp_cells[i+1]] == [0,0,1]:
                new_cells[i-1] = 1

            elif [temp_cells[i-1],temp_cells[i],temp_cells[i+1]] == [0,0,0]:
                new_cells[i-1] = 0
